...
// Returns an icon by examining the name for the format ICON_LIBRARY.ICON_NAME
// For example fa.fiveHundredPx returns the icon named fiveHundredPx in the FontAwesome lib, if it didn't exist, you get null.
IconData? getIconUsingPrefix({required String name}) => getFontAwesomeIcon(name: name);
